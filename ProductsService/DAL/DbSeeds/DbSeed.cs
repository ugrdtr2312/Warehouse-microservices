    ...
    public static class DbSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Supplier>().HasData(
                new Supplier{ Id=1, CompanyName = "Sidorov company"},
                new Supplier{ Id=2, CompanyName = "Stepaniuk warehouse"},
                new Supplier{ Id=3, CompanyName = "Fedorenko storage"},
                new Supplier{ Id=4, CompanyName = "Dolid delivery"}
            );
