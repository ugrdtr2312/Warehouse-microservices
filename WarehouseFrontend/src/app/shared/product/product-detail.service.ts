...
export class ProductDetailService {
  ...
  readonly baseURL = "http://192.168.39.7:80/products/api/products"
  ...
  refreshList(){
    ...
    this.http.get("http://192.168.39.7:80/categories/api/categories").toPromise()
    .then(res => this.categoryList = res as CategoryDetail[]);
    this.http.get("http://192.168.39.7:80/brands/api/brands").toPromise()
    .then(res => this.brandList = res as BrandDetail[]);
    this.http.get("http://192.168.39.7:80/suppliers/api/suppliers").toPromise()
